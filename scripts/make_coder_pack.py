"""Build a blind coding pack for a second coder.
    ...
    python scripts/make_coder_pack.py \
        --master oshc-master-data-v7.1.xlsx --coder Minhaj
...
def main() -> int:
    ...
    lines = [
        ...
        (
            (
                "This pack deliberately contains no codes. If you see anyone else's "
                "codes "
                "before you finish, the agreement statistic we compute afterwards "
                "measures "
                "nothing and the work has to be redone."
            ),
            False,
        ),
        ("", False),
        ...
        (
            (
                "1. Read each snippet on the Coding sheet. Code the text as written. "
                "Do not "
                "infer a backstory the words do not state."
            ),
            False,
        ),
        ...
        (
            (
                "5. Send the file back. Do not discuss any record with Bikram until "
                "both "
                "passes are in."
            ),
            False,
        ...
        (
            (
                "Y only when the text shows the person misunderstood something: a "
                "question "
                "about how it works, a stated wrong belief ('I thought', 'I didn't "
                "know'), "
                "or surprise that reveals a wrong expectation."
            ),
            False,
        ),
        (
            (
                "N when the person shows they understood what should happen and "
                "complains "
                "that it did not happen, happened slowly, or happened badly. Also N "
                "when "
                "they dislike a policy term they plainly understand. Complaining about "
                "an "
                "amount is not by itself a gap. Asking why the amount was what it was "
                "is."
            ),
            False,
        ),
        (
            (
                "Illustrations, not from the data: 'I assumed the pharmacy would bill "
                "my "
                "insurer directly' is Y. 'Third phone call and my claim is still "
                "sitting "
                "there' is N. 'The dental limit is too low for what it costs' is N."
            ),
            False,
        ),
        ("", False),
        (
            (
                "Rule 2. Gap = N always takes Code 1 = S. Gap = Y never takes Code 1 = "
                "S. "
                "S may appear as Code 2 on a gap record that also contains a service "
                "complaint."
            ),
            True,
        ),
        ...
        (
            (
                "C2 when the confusion is about the policy's terms, the kind that "
                "exists "
                "before any claim: what is in or out, limits, caps, waiting periods, "
                "what "
                "'covered' means."
            ),
            False,
        ...
        (
            (
                "C4 when the confusion comes from paying and claiming: paying first, "
                "forms, "
                "how much came back, a gap on a particular bill."
            ),
            False,
        ),
        (
            (
                "When both apply, Code 1 is whichever the person is actually asking or "
                "complaining about, and the other goes in Code 2."
            ),
            False,
        ),
        ("", False),
        ...
        (
            (
                "C1 against C2: C1 when they do not understand what OSHC is or why "
                "they "
                "have it. C2 when they know it is insurance and misjudged its scope."
            ),
            False,
        ),
        (
            (
                "C3 against C5: C3 when they know what care they need and cannot find, "
                "book or reach it. C5 when they went to the wrong kind of service."
            ),
            False,
        ),
        (
            (
                "C5 against C6: C6 when the question is how to get emergency or urgent "
                "help. C5 when they used emergency care for something that was not an "
                "emergency."
            ),
            False,
        ),
    ...
    for col, w in zip("ABCDE", (16, 95, 12, 12, 8), strict=True):
